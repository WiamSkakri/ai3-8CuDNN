...
def main():
    ...
    pytorch_model = models.googlenet(weights=models.GoogLeNet_Weights.DEFAULT)
    pytorch_model.eval()
    ...
    ai3_model = models.googlenet(weights=models.GoogLeNet_Weights.DEFAULT)
    ai3_model.eval()
    ...
    if ai3_ai3 > 0 and ai3_pytorch == 0:
        print("✓ All 60+ Conv2D layers were replaced with ai3 Implicit GEMM implementation")
