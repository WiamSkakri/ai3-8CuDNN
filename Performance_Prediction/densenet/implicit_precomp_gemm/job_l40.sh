#!/bin/bash
#SBATCH --job-name=densenet_implicit_precomp_gemm_l40s
#SBATCH --output=densenet_implicit_precomp_gemm_results_l40s/densenet_implicit_precomp_gemm_l40s_%j.out
#SBATCH --error=densenet_implicit_precomp_gemm_results_l40s/densenet_implicit_precomp_gemm_l40s_%j.err
...
RESULTS_DIR="densenet_implicit_precomp_gemm_results_l40s"
