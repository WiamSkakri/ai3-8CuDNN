#!/usr/bin/env python3
"""Verification: PyTorch vs ai3 FFT Tiling (GoogLeNet)"""
...
def main():
    print("="*80)
    print("VERIFICATION: PyTorch vs ai3 FFT Tiling (GoogLeNet)")
    print("="*80)
    ...
    pytorch_stats = measure_time(googlenet, input_data, use_cuda)
    print(f"PyTorch: {pytorch_stats['mean']:.2f}ms")

    ai3_model = ai3.swap_conv2d(googlenet, 'fft tiling')
