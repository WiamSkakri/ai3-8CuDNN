"""ResNet152 Performance Test with cuDNN FFT Algorithm"""
...
def test_resnet152_fft():
    ...
    with torch.inference_mode():
        ...
        compare_tensors(
            fft_out, torch_out, f'{ALGORITHM.upper()} vs PyTorch', print_pass=True, atol=1e-4)
...
if __name__ == '__main__':
    sys.exit(0 if test_resnet152_fft() else 1)
