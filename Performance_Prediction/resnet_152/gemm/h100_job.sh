#!/bin/bash
#SBATCH --job-name=resnet152_gemm_h100
#SBATCH --output=resnet152_gemm_results_h100/resnet152_gemm_h100_%j.out
#SBATCH --error=resnet152_gemm_results_h100/resnet152_gemm_h100_%j.err
...
RESULTS_DIR="resnet152_gemm_results_h100"
