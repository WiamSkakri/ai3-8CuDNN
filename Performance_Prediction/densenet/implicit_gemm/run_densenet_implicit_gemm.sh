#!/bin/bash
#SBATCH --job-name=densenet_implicit_gemm_v100
#SBATCH --output=densenet_implicit_gemm_results_v100/densenet_implicit_gemm_v100_%j.out
#SBATCH --error=densenet_implicit_gemm_results_v100/densenet_implicit_gemm_v100_%j.err
...
RESULTS_DIR="densenet_implicit_gemm_results_v100"
