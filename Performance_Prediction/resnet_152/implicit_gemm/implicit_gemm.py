"""ResNet152 Performance Test with cuDNN Implicit GEMM Algorithm"""
...
def test_resnet152_implicit_gemm():
    print("\n" + "=" * 70)
    ...
    with torch.inference_mode():
        ...
        implicit_gemm_out = predict_show_time(
            model, input_data, f'ai3 ResNet152 ({ALGORITHM.upper()})')
        compare_tensors(implicit_gemm_out, torch_out,
...
if __name__ == '__main__':
    sys.exit(0 if test_resnet152_implicit_gemm() else 1)
