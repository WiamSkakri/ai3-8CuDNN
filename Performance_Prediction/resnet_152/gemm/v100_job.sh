#!/bin/bash
#SBATCH --job-name=resnet152_gemm_v100
#SBATCH --output=resnet152_gemm_results_v100/resnet152_gemm_v100_%j.out
#SBATCH --error=resnet152_gemm_results_v100/resnet152_gemm_v100_%j.err
...
RESULTS_DIR="resnet152_gemm_results_v100"
