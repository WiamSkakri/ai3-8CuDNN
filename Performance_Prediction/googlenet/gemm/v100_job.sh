#!/bin/bash
#SBATCH --job-name=googlenet_gemm_v100
#SBATCH --output=googlenet_gemm_results_v100/googlenet_gemm_v100_%j.out
#SBATCH --error=googlenet_gemm_results_v100/googlenet_gemm_v100_%j.err
...
RESULTS_DIR="googlenet_gemm_results_v100"
