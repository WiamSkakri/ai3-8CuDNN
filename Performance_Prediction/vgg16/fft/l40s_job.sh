#!/bin/bash
#SBATCH --job-name=vgg16_fft_l40s
#SBATCH --output=vgg16_fft_results_l40s/vgg16_fft_l40s_%j.out
#SBATCH --error=vgg16_fft_results_l40s/vgg16_fft_l40s_%j.err
...
RESULTS_DIR="vgg16_fft_results_l40s"
