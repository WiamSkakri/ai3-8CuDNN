...
def main():
    print("="*80)
    print("VERIFICATION: PyTorch Default vs ai3 GEMM - ResNet152")
    print("="*80)
    ...
    pytorch_model = models.resnet152(weights=models.ResNet152_Weights.DEFAULT)
    pytorch_model.eval()
    ...
    ai3_model = models.resnet152(weights=models.ResNet152_Weights.DEFAULT)
    ai3_model.eval()
