#!/usr/bin/env python3
"""
ResNet152 FFT Tiling Performance Profiling with Power Monitoring - FULL VERSION

This script adds power consumption monitoring to the performance profiling,
running on 100 input sizes from 224x224 to 512x512 using FFT Tiling algorithm.
"""
...
def main():
    ...
    print("=" * 80)
    print("RESNET152 FFT PERFORMANCE + POWER PROFILING - FULL VERSION")
    print("=" * 80)
    ...
    # Use fft_tiling in filename (replace space with underscore)
