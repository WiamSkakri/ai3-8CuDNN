#!/bin/bash
#SBATCH --job-name=googlenet_gemm_h100
#SBATCH --output=googlenet_gemm_results_h100/googlenet_gemm_h100_%j.out
#SBATCH --error=googlenet_gemm_results_h100/googlenet_gemm_h100_%j.err
...
RESULTS_DIR="googlenet_gemm_results_h100"
