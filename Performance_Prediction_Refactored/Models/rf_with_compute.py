...
Includes an engineered 'compute' feature (FLOPs proxy).
"""
...
def main():
    ...
    print("\nTraining Random Forest (with compute feature)...")
    ...
    artifact_path = os.path.join(out_dir, "rf_with_compute.joblib")
