#!/bin/bash
#SBATCH --job-name=vgg16_gemm_profile
#SBATCH --output=vgg16_gemm_results/vgg16_gemm_%j.out
#SBATCH --error=vgg16_gemm_results/vgg16_gemm_%j.err
...
RESULTS_DIR="vgg16_gemm_results"
