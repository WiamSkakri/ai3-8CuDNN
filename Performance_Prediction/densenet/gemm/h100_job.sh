#!/bin/bash
#SBATCH --job-name=densenet_gemm_h100
#SBATCH --output=densenet_gemm_results_h100/densenet_gemm_h100_%j.out
#SBATCH --error=densenet_gemm_results_h100/densenet_gemm_h100_%j.err
...
RESULTS_DIR="densenet_gemm_results_h100"
