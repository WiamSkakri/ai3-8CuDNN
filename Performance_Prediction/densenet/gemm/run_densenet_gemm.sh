#!/bin/bash
#SBATCH --job-name=densenet_gemm_v100
#SBATCH --output=densenet_gemm_results_v100/densenet_gemm_v100_%j.out
#SBATCH --error=densenet_gemm_results_v100/densenet_gemm_v100_%j.err
...
RESULTS_DIR="densenet_gemm_results_v100"
