#!/usr/bin/env python3
"""
GoogLeNet FFT Tiling Performance Profiling with Power Monitoring - FULL VERSION
...
import torch
from googlenet_gemm import PowerMonitor, CUDALayerTimer, measure_overall_performance, format_tuple_value, print_cuda_info
import sys
import os
...
def main():
    ...
    print("=" * 80)
    print("GOOGLENET FFT PERFORMANCE + POWER PROFILING - FULL VERSION")
    print("=" * 80)
