#!/bin/bash
#SBATCH --job-name=vgg16_winograd_nonfused_l40
#SBATCH --output=vgg16_winograd_nonfused_results_l40/vgg16_winograd_nonfused_l40_%j.out
#SBATCH --error=vgg16_winograd_nonfused_results_l40/vgg16_winograd_nonfused_l40_%j.err
...
RESULTS_DIR="vgg16_winograd_nonfused_results_l40"
