#!/bin/bash
#SBATCH --job-name=vgg16_winograd_v100
#SBATCH --output=vgg16_winograd_results_v100/vgg16_winograd_v100_%j.out
#SBATCH --error=vgg16_winograd_results_v100/vgg16_winograd_v100_%j.err
...
RESULTS_DIR="vgg16_winograd_results_v100"
